...
public class LanguageModel {
    ...
    public void train(String fileName) {
        String window = "";
        char c;
        In in = new In(fileName);for (int i = 0; i < windowLength; i++)
        {
     ...
     * @param initialText - text to start with. If initialText's last substring of size numberOfLetters* doesn't appear as a key in Map, we generate no text and return only the initial text.
    ...
    public String generate(String initialText, int textLength)
    {
        ...
        // Returns the generated textreturn gt;
    }
